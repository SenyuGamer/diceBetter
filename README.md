...
### 🎲 BetterDice (Extensión para Owlbear Rodeo)
...
### 1. Activar BetterDice en Owlbear Rodeo
...
```text
├── .github/workflows/   # Flujos de CI/CD para compilar BetterDice y empaquetar BeyondOwl
...
└── src/                 # Código fuente de BetterDice (React + Three.js)
...
- Basado originalmente en el trabajo de código abierto de [Owlbear Rodeo Dice Roller](https://github.com/owlbear-rodeo/dice) y la arquitectura de mensajería de [Beyond20](https://github.com/kakaroto/Beyond20).
